...
void RtxApp::LoadSceneGeometry() {
    ...
    String fileName = "scenes/fake_whitted/fake_whitted.obj";
...
void RtxApp::CreateRaytracingPipelineAndSBT() {
    ...
    rayGenShader.LoadFromFile("shaders/ray_gen.spv");
    rayChitShader.LoadFromFile("shaders/ray_chit.spv");
    rayMissShader.LoadFromFile("shaders/ray_miss.spv");
    shadowChit.LoadFromFile("shaders/shadow_ray_chit.spv");
    shadowMiss.LoadFromFile("shaders/shadow_ray_miss.spv");
